...
void Init(){
    ...
    //! histograms
    h_max_z = new TH1F("h_max_z","h_max_z",8,-5,4);
...
void OpenFile(const char* filename){
    ...
    tree->Branch("dssd_mutlx",dssd_mutlx,Form("dssd_mutlx[%d]/I",N_DSSD));
    ...
    tree->Branch("dssd_mutly",dssd_mutly,Form("dssd_mutly[%d]/I",N_DSSD));
}
