...
void Init(){
    ...
    hrate = new TH1F("hrate","He3 total rate",3600,0,3600);
...
//            }
            ...
            if (hit->clong>200&&hit->clong<1700){
                if (start_ts==0) start_ts = hit->ts;
                Long64_t tscurr_ns = (Long64_t)hit->ts - start_ts;
