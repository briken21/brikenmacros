...
// Tue Apr 27 05:44:11 2021 by ROOT version 6.22/08
// from TTree tree/tree
// found on file: wasabi/run0103.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   wasabi(char* infile, TTree *tree=0);
   virtual ~wasabi();
...
wasabi::wasabi(char* infile, TTree *tree) : fChain(0)
{
